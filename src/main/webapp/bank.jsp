...
<div class="divContent" >
	...
	<span class="spanPrice">支付金额：</span><span class="price_t">&yen;${param.money }</span><br/><br/>
	<span class="spanOid">编号：${param.orderid }</span>
</div>
<br/>
<form action="<c:url value='/payServlet'/>" method="post" id="form1">
